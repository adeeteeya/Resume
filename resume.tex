...
\documentclass[letterpaper,30pt]{article}
...
\begin{center}
    ...
    \small (571)-274-1651 $|$ \href{mailto:a@sathish.io}{\underline{a@sathish.io}} $|$ 
    \href{https://www.linkedin.com/in/adityasathish-io/}{\underline{linkedin.com/in/adityasathish-io}} $|$
    \href{https://github.com/adityasathish-io}{\underline{github.com/adityasathish-io}} $|$
    \href{https://sathish.io.io}{\underline{aditya.sathish.io}}
\end{center}

%-----------SUMMARY-------------
\section{Summary}
Wireless systems engineer with 7+ years of experience in Wi-Fi (IEEE 802.11ax/be/bn), 5G NR and NR-U protocols.
Proven track record in device driver development, MAC layer design, and wireless testbed deployment. Thorough
experience in software-defined networking (SDN), software-defined radios (SDRs), network simulation, and
standards-driven R\&D in wireless systems at Qualcomm and Virginia Tech.
...
\section{Education}
  \resumeSubHeadingListStart
    ...
    %   {Doctor of Philosophy (Ph.D.) in Computer Engineering, GPA: 3.78/4.0}{Aug 2022 -- May 2026 (Est.)}
    \resumeSubheading
      {Virginia Tech}{Arlington, VA, USA}
      {Master of Science (M.S., Thesis) in Computer Engineering, GPA: 3.78/4.0}{Aug 2022 -- Sept 2024}
    \resumeSubheading
...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Developed the low-level design and RFC in hostapd, mac80211 and ath12k for Wi-Fi 8 Seamless Mobility Domain (SMD)}
        \resumeItem{Solved numerous engineering challenges in the Qualcomm Wi-Fi 7 Access Point (AP) hardware platforms}
        \resumeItem{Worked on Wi-Fi 7 as well as EZmesh specifications for multi-AP co-ordination and connectivity for seamless roaming}
      \resumeItemListEnd
...
\section{Professional Organizations}
    \resumeSubHeadingListStart
      ...
      \resumeOrgHeading
      {\textbf{Rotaract Club, NITK Chapter} $|$ \emph{Rotary, NITK}}{Aug 2014 -- May 2017}
    \resumeSubHeadingListEnd
